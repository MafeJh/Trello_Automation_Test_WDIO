...
import LandingPage from '../po/pages/landing.page';
import SignInPage from '../po/pages/sign-in.page';
import HomeBoardsPage from '../po/pages/home-boards.page';
import ProfileAndVisibilityPage from '../po/pages/profile-and-visibility.page';
import HeaderPage from '../po/pages/header.page';
import BoardPage from '../po/pages/board.page';
import WorkspacePage from '../po/pages/workspace.page';

// PAGES
let landingPage: LandingPage,
  signInPage: SignInPage,
  homeBoardsPage: HomeBoardsPage,
  profileAndVisibility: ProfileAndVisibilityPage,
